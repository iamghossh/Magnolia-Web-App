...
function CreateTrip() {
  ...
  return (
    <div className='sm:px-10 md:px-56 xl:px-15 px-5 mt-10 py-5'>
        <h2 className='font-bold text-3xl'> Tell us your travel prefernces🌴🏘️🗺️</h2>
      ...
      <div className='pt-8'>
        <h2 className='text-xl my-3 font-medium'>Who do you plan on traveling on your next adventure? </h2>
      ...
      <div className='my-10 justify-end flex text-white rounded-sm'>
